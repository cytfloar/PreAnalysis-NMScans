...
def convert(sub, ses):
  ...
  os.system(f"""/Applications/MRIcroGL.app/Contents/Resources/dcm2niix -f "sub-{sub}_ses-{ses}_STRUC_2D_GRE_MT_1p5mm_NEX5_18_2" -p y -z y -o "horga/{sub}/NM_NEX5" "NM Pilot Phase 2/{ses}/scans/4-STRUC_2D_GRE_MT_1p5mm_NEX5/resources/DICOM/files" """)
